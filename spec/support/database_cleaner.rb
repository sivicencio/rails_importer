# Database Cleaner Configuration Reference
...
RSpec.configure do |config|
  ...
  # By default, these are the only tests for which Capybara fires up a test server process and drives an actual browser
  # window via the Selenium backend. For these types of tests, transactions won’t work,
  # so this code overrides the setting and chooses the “truncation” strategy instead.
